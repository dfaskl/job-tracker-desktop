(function(){
  ...
  renderSettings=function(){
    ...
    if(settingsGrid&&dataPanel){const rightColumn=document.createElement('div');rightColumn.className='settings-right-column';dataPanel.replaceWith(rightColumn);rightColumn.appendChild(dataPanel);rightColumn.insertAdjacentHTML('beforeend',`<div class="panel settings-section backup-settings-section"><div class="panel-head"><div><h2>云端历史备份</h2><p>最多保留最近 30 份；恢复前会自动保存当前数据。</p></div><button class="link-btn" type="button" onclick="loadCloudBackups()">刷新</button></div><div class="backup-list" id="backupList"><div class="empty compact">正在读取备份…</div></div></div><div class="panel settings-section about-settings-section"><div class="about-brand"><span>✓</span><div><h2>求职进度本</h2><p>私密、专注、可同步的求职管理工具</p></div></div><dl><div><dt>数据位置</dt><dd>云端 PostgreSQL（按账号隔离）</dd></div><div><dt>API 配置</dt><dd>服务端加密存储</dd></div><div><dt>更新渠道</dt><dd><a href="https://github.com/dfaskl/job-tracker-desktop" target="_blank" rel="noreferrer">GitHub 项目主页 ↗</a></dd></div></dl></div>`);loadBackups();}
  };
