...
assert.match(officialMonitorClient, /job-tracker-official-capture/);
...
assert.match(extensionPopup, /document\.body\?\.innerText/);
assert.doesNotMatch(extensionPopup, /document\.cookie|input\.value/);
