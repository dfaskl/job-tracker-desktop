...
assert.match(commercialCss, /\.settings-right-column\{grid-template-rows:auto minmax\(0,1fr\);height:100%\}/);
assert.match(commercialCss, /\.settings-right-column \.backup-list\{flex:1;max-height:none;min-height:0\}/);
