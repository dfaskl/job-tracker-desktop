...
<style scoped>
.access,.signed{display:flex;align-items:center;gap:18px;margin-top:22px;padding:16px 20px;border:1px solid #dbe3f1;border-radius:15px;background:#fff}.access>div,.signed>div{display:grid;gap:4px;min-width:190px}.access span,.signed span{color:#667085;font-size:12px}.access form{display:grid;grid-template-columns:1fr 1fr 1fr auto;flex:1;gap:9px}.switch{padding:8px;color:#4461d8;background:transparent;white-space:nowrap}.access p{width:100%;margin:0}.signed{justify-content:space-between}.secondary{color:#344054;background:#eef2f8}.signed.compact{display:grid;width:100%;box-sizing:border-box;gap:10px;margin:0 auto;padding:12px;place-items:center;text-align:center;color:#dce5ff;border-color:#344362;background:#202c43}.signed.compact>div{display:grid;width:100%;min-width:0;place-items:center;justify-content:center}.signed.compact strong{display:block;width:100%;overflow:hidden;text-align:center;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.signed.compact span{display:block;width:100%;text-align:center;color:#91a0c5;font-size:10px}.signed.compact button{width:min(140px,100%);justify-self:center;padding:7px;color:#dce5ff;border:1px solid #40506d;background:transparent}@media(max-width:900px){.access{align-items:stretch;flex-direction:column}.access form{grid-template-columns:1fr}.switch{text-align:left}.signed{margin-top:14px}}
</style>
