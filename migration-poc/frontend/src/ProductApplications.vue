  ...
  <div class="application-toolbar-portal">
    ...
    <div v-if="store.user.value" class="toolbar">
      <div class="application-filter-stack">
        <div class="application-filter-fields"><input v-model="query" type="search" placeholder="搜索公司、岗位、地点、渠道或备注"><BaseSelect v-model="stageFilter" :options="['全部',...stageCategories]" align="center" /></div>
