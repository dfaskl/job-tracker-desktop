...
type ScheduleAdvice = { summary: string; plans: string[]; warnings?: string[]; conflicts: string[] }
...
function adviceCacheKey(){return 'job_tracker_schedule_advice_v7_'+String(store.user.value?.email||'guest').toLowerCase()}
