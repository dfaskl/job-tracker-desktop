...
@media (max-width: 720px) {
  ...
  .calendar-layout { display: flex; width: 100%; height: auto; min-height: 0; flex-direction: column; gap: 12px; margin-top: 12px; }
  .calendar-pane, .selected-list { width: 100%; min-width: 0; }
  .calendar-pane { min-height: 440px; }
  .calendar-pane .calendar-head { padding: 12px; }
  .calendar-pane .calendar-grid { min-height: 360px; flex: none; grid-template-rows: repeat(6, 60px); }
  ...
  .day-events > .event-chip { width: 100%; height: 7px; padding: 0; border-radius: 99px; color: transparent; font-size: 0; line-height: 0; }
  .day-events > .event-chip.start, .day-events > .event-chip.end { margin-inline: 0; border-radius: 99px; }
  .day-events > .event-chip.middle { height: 5px; margin-inline: -3px; }
...
<style scoped>
:global(:root[data-theme="dark"]) .selected-list {
  border-color: var(--color-border);
  color: var(--color-card-foreground);
  background: var(--color-card) !important;
}

:global(:root[data-theme="dark"]) .selected-list > h3 {
  border-color: var(--color-border);
  color: var(--color-foreground);
  background: var(--color-card);
}

:global(:root[data-theme="dark"]) .selected-scroll {
  background: var(--color-card);
  scrollbar-color: var(--color-border-strong) transparent;
}

:global(:root[data-theme="dark"]) .selected-list article {
  border-color: var(--event-color);
  color: var(--color-card-foreground);
  background: color-mix(in srgb, var(--event-color) 11%, var(--color-muted)) !important;
}

:global(:root[data-theme="dark"]) .selected-list .event-main strong {
  color: var(--color-foreground);
}

:global(:root[data-theme="dark"]) .selected-list .event-main span {
  color: var(--color-muted-foreground);
}

:global(:root[data-theme="dark"]) .selected-list .empty {
  border-color: var(--color-border);
  color: var(--color-muted-foreground);
