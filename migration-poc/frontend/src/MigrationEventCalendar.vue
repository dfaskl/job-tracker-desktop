...
@media(min-width:821px) and (min-height:620px){.event-sandbox{display:flex;height:calc(100vh - 124px);min-height:0;margin-top:12px!important;flex-direction:column;overflow:hidden}.event-sandbox>.section-head{flex:0 0 auto}.event-sandbox>.calendar-layout{min-height:0;flex:1;height:auto;max-height:none;margin-top:12px}}
