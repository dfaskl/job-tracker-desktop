...
<template>
  <div class="product-shell">
    ...
    <main class="product-main" :class="{ 'application-page': activePage === 'applications', 'calendar-page': activePage === 'calendar', 'mail-page-shell': activePage === 'mail', 'settings-page-shell': activePage === 'settings', 'admin-page-shell': activePage === 'admin' }">
      <header class="topbar">
...
.product-main.application-page, .product-main.calendar-page, .product-main.mail-page-shell, .product-main.settings-page-shell, .product-main.admin-page-shell { height: 100vh; overflow: hidden; padding-bottom: 0; }
.topbar p { margin: 0; line-height: 1.4; }
.page-content { width: min(1120px, 100%); margin: 0 auto; }
.page-content.application-content, .page-content.calendar-content, .page-content.mail-content, .page-content.settings-content, .page-content.admin-content { width: 100%; max-width: none; }
.page-content.mail-content, .page-content.settings-content, .page-content.admin-content { height: calc(100vh - 112px); }
...
@media (max-width: 900px) { .product-main.mail-page-shell { height: auto; overflow: visible; padding-bottom: 48px; } .page-content.mail-content, .page-content.settings-content, .page-content.admin-content { height: auto; } }
