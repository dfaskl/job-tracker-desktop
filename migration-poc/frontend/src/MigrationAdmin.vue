...
.users-card .counts{min-width:200px;gap:10px}.users-card .actions{width:192px;flex:0 0 192px;gap:8px}.users-card .actions button.icon-button{width:42px;min-width:42px;flex:0 0 42px;padding:0;white-space:nowrap}@media(max-width:720px){.users-card .counts{min-width:0;gap:14px}.users-card .actions{width:100%;flex-basis:auto;gap:12px}.users-card .actions button.icon-button{width:42px;min-width:42px;flex:0 0 42px}}
