...
const actionLabels:Record<string,string>={'disable-user':'停用账号','enable-user':'启用账号','delete-user':'删除账号','open-registration':'开放注册','close-registration':'关闭注册','set-registration-code':'设置注册码','clear-registration-code':'清除注册码','view-user-details':'查看用户详情','revoke-sessions':'撤销登录会话'}
