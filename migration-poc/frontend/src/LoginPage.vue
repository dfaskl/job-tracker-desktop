...
const illustrationStyle = computed(() => ({
  '--look-x': `${pointerX.value * 14}px`,
  '--look-y': `${pointerY.value * 10}px`,
  '--stage-x': `${pointerX.value * 18}px`,
  '--stage-y': `${pointerY.value * 8}px`,
  '--tilt': `${pointerX.value * 10}deg`,
  '--tilt-reverse': `${pointerX.value * -8}deg`,
  '--tilt-soft': `${pointerX.value * 5}deg`,
  '--tilt-soft-reverse': `${pointerX.value * -4}deg`
}))
...
<template>
  <main id="login-page" class="login-page" @pointermove="trackPointer" @pointerleave="resetPointer">
...
.character-stage{position:absolute;left:50%;bottom:clamp(96px,14vh,150px);z-index:2;width:min(550px,78%);height:min(480px,54vh);transform:translate3d(calc(-50% + var(--stage-x)),var(--stage-y),0);transition:transform .18s ease-out}.creature{position:absolute;bottom:0;transform-origin:bottom center;will-change:transform,translate;animation:creature-float 3.2s ease-in-out infinite;transition:height .55s cubic-bezier(.2,.8,.2,1),transform .18s ease-out}.creature-purple{left:13%;z-index:1;width:33%;height:88%;border-radius:11px 11px 0 0;background:var(--purple);transform:skewX(var(--tilt));animation-duration:3.8s}.creature-charcoal{left:44%;z-index:2;width:22%;height:68%;border-radius:9px 9px 0 0;background:var(--charcoal);transform:skewX(var(--tilt-reverse));animation-delay:-1.1s;animation-duration:3.4s}.creature-orange{left:2%;z-index:3;width:44%;height:43%;border-radius:999px 999px 0 0;background:var(--orange);transform:skewX(var(--tilt-soft));animation-delay:-2.2s;animation-duration:4.1s}.creature-yellow{left:57%;z-index:4;width:27%;height:50%;border-radius:999px 999px 0 0;background:var(--yellow);transform:skewX(var(--tilt-soft-reverse));animation-delay:-.6s;animation-duration:3.6s}
...
.character-stage.is-email-active .creature-purple{height:98%;transform:skewX(-12deg) translateX(42px)}.character-stage.is-email-active .creature-charcoal{transform:skewX(12deg) translateX(22px)}.character-stage.is-email-active .creature-orange{transform:skewX(5deg) translateX(8px)}.character-stage.is-email-active .face{--look-x:10px;--look-y:8px}.character-stage.is-password-private .creature-purple{height:98%;transform:skewX(-14deg) translateX(48px)}.character-stage.is-password-private .creature-charcoal{transform:skewX(11deg) translateX(28px)}.character-stage.is-password-private .face{--look-x:-10px;--look-y:-8px}.character-stage.is-password-private .two-eyes i{animation:none;transform:scaleY(.18)}.character-stage.is-password-private .dot-eyes{transform:translate(calc(var(--look-x) - 6px),var(--look-y))}.character-stage.is-password-visible .face{--look-x:-9px;--look-y:9px}.character-stage.is-password-visible .creature-purple,.character-stage.is-password-visible .creature-charcoal,.character-stage.is-password-visible .creature-orange,.character-stage.is-password-visible .creature-yellow{transform:skewX(0)}.character-stage.is-password-visible .mouth{animation:mouth-smile .55s ease both}
...
@keyframes creature-float{0%,100%{translate:0 0}50%{translate:0 -12px}}
@keyframes mouth-smile{to{height:17px;border-radius:0 0 999px 999px;background:transparent;box-shadow:inset 0 -4px 0 var(--charcoal)}}
