...
<style scoped>
.analytics-layout{display:grid;width:100%;grid-template-columns:minmax(340px,1fr) minmax(0,2fr);gap:20px;align-items:start;padding:22px 0 28px}.analytics-main{display:grid;min-width:0;gap:18px}.analytics-main .metrics{margin-top:0}
...
@media(max-width:1180px){.analytics-layout{grid-template-columns:minmax(300px,1fr) minmax(0,2fr)}.metrics{grid-template-columns:1fr 1fr}.two-column{grid-template-columns:1fr}.trend{gap:4px}}
