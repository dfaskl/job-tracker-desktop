...
ALTER TABLE users ADD COLUMN IF NOT EXISTS group_id BIGINT REFERENCES interview_groups(id) ON DELETE SET NULL;
...
CREATE TABLE IF NOT EXISTS mail_accounts (
  ...
  collect_after TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  UNIQUE(user_id,email)
);
ALTER TABLE mail_accounts ADD COLUMN IF NOT EXISTS initialized BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE mail_accounts ADD COLUMN IF NOT EXISTS collect_after TIMESTAMPTZ NOT NULL DEFAULT NOW();
